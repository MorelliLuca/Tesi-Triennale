...
Questo è quindi composto da $N$ particelle libere, siccome non vi sono interazioni, perciò si ha che le energie e i momenti delle singole particelle si conservano.\\
...
Inoltre se si considera la trasformazione di Lorentz da un sistema arbitrario ad un sistema in moto a velocità $\vec v_{CM}$ si osserva dalle \eqref{TrasfLorentzEI} che in tale sistema l'impulso totale del sistema è nullo. Infatti la somma di 4-vettori è ancora un 4-vettore e quindi $p_{tot}^\mu=\sum p^\mu$ e considerando che le trasformazioni di Lorentz sono lineari si ha che questo si trasforma nella somma dei 4-impulsi del nuovo sistema di riferimento:
\begin{equation*}
    p^\mu_{Tot}\Lambda_\mu^\nu=\sum_{particelle} p^\mu\Lambda_\mu^\nu=\sum_{particelle} p'^\nu=p'^\nu_{Tot}.
\end{equation*}
Se $\Lambda_\mu^\nu$ è la trasformazione appena descritta, dove si è orientato l'asse $x$ con la direzione del moto del centro di massa, si ha:
\begin{equation*}
    \vec{p'}_{Tot}=\bigg( \vec{p}_{Tot}-\frac{c^2 \vec{p}_{Tot}}{c^2 \vec{p}_{Tot}}E_{Tot}\bigg)\gamma=0, \quad E_{Tot}'=\bigg(E_{Tot}-\frac{c^2(\vec{p}_{Tot})^2}{E_{Tot}}\bigg)\gamma=\sqrt{E^2_{Tot}-c^2(\vec{p}_{Tot})^2}. 
\end{equation*}
