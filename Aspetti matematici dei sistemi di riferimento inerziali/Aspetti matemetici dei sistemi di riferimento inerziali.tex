...
\begin{proof}[Dimostrazione teorema \ref{thm:LinGenMain}]
	...
	\begin{figure}[h!]
		...
		\draw[black, thick] (-1+10,-0.245) -- (3+10,0.75) node[anchor=south]{$g(r_2)$};
		\draw[black, thick] (-.5+10,1.755) -- (3.5+10,2.75) node[anchor=south]{$g(r_4)$};
		\draw[black, thick] (-0.257+10,-1) -- (0.75+10,3) node[anchor=west]{$g(r_1)$}; 
		\draw[black, thick] (1.61+10,-1) -- (2.75+10,3.5) node[anchor=west]{$g(r_3)$};
